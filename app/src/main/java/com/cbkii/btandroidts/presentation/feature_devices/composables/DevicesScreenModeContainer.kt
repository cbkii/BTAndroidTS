...
import com.cbkii.btandroidts.presentation.composables.BTNotEnabledBox
import com.cbkii.btandroidts.presentation.composables.BtPermissionNotProvidedBox
import com.cbkii.btandroidts.presentation.feature_devices.util.BluetoothScreenType
...
@PreviewLightDark
@Composable
private fun DevicesScreenModeContainerBTNotActivePreview() = BTAndroidTSTheme {
	Surface {
...
@PreviewLightDark
@Composable
private fun DevicesScreenModeContainerPermissionNotProvided() = BTAndroidTSTheme {
	Surface {
		DevicesScreenModeContainer(
			isActive = true,
			hasPermission = false,

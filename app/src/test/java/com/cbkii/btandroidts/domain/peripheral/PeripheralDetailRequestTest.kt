...
class PeripheralDetailRequestTest {
    ...
    fun validArgsParseAddressAndName() {
        val request = PeripheralDetailRequest.fromArgs(PeripheralDetailArgs("00:11:22:33:44:55", "Keyboard"))
    ...
    fun invalidAddressIsHandledDeterministically() {
        val request = PeripheralDetailRequest.fromArgs(PeripheralDetailArgs("not-a-mac", "Keyboard"))
    ...
    fun blankNameIsNotUsedAsFallback() {
        val request = PeripheralDetailRequest.fromArgs(PeripheralDetailArgs("00:11:22:33:44:55", " "))
        assertEquals(BluetoothAddress.requireValid("00:11:22:33:44:55"), request.address)

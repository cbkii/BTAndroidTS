# Agent notes for NordicSemiconductor/Android-BLE-Library
...
```bash
grep -R "BluetoothHidDevice\|registerApp\|sendReport\|BluetoothProfile.HID_DEVICE" -n docs/reference/repos/android-ble-library/src | head -100
grep -R "00001812\|HID_SERVICE\|Report Map\|ScanSettings\|setLegacy\|setPhy" -n docs/reference/repos/android-ble-library/src | head -100
```

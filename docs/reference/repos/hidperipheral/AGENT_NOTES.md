# Agent notes for LiangLuDev/HidPeripheral
...
```bash
grep -R "BluetoothHidDevice\|registerApp\|sendReport\|BluetoothProfile.HID_DEVICE" -n docs/reference/repos/hidperipheral/src | head -100
grep -R "00001812\|HID_SERVICE\|Report Map\|ScanSettings\|setLegacy\|setPhy" -n docs/reference/repos/hidperipheral/src | head -100
```
